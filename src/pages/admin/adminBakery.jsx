        ...
        {bakeryItems.map((item) => (
          <div key={item._id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-rose-500 font-bold">Rs {item.price}</span>
            </div>
            <p className="text-sm text-gray-400 mb-6">{item.category?.name}</p>
            
            <div className="flex gap-3">
              <button className="flex-1 flex items-center justify-center gap-2 border py-2 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors">
