...
import {
    CheckCircle2, Save, Edit2, ShieldCheck, LogOut, X
} from "lucide-react";
            ...
            <main className="max-w-[1100px] mx-auto px-6 py-12">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="lg:w-64 space-y-1">
                        {["My Profile", "Change Password", "Logout"].map((name) => (
                            <button
                                key={name}
                            ...
                            {activeTab === "Change Password" && (
                                <div className="max-w-md animate-in fade-in duration-300">
                                    ...
                                    <button
                                        ...
                                        className="mt-6 w-full flex items-center justify-center gap-2 bg-[#E24C63] text-white py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-lg shadow-rose-100 hover:bg-[#c93d52] transition-all active:scale-95"
                                    >
                                        <ShieldCheck size={16} />
                                        Update Password
                                    </button>
                    ...
                    <div className="bg-white w-full max-w-[340px] rounded-[28px] p-8 shadow-2xl relative animate-in zoom-in duration-200 text-center">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 py-3 rounded-xl font-bold text-xs text-gray-400 bg-gray-50 hover:bg-gray-100 transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                                onClick={handleLogout}
                                className="flex-1 py-3 rounded-xl font-bold text-xs text-white bg-[#E24C63] shadow-lg shadow-rose-100 hover:bg-[#c93d52] transition-colors"
                            >
                                Yes, Logout
                            </button>
                        </div>
...
const EditableDetail = ({ label, value, isEditing, onChange }) => (
    <div>
        ...
        {isEditing ? (
            ...
            <div className="bg-[#FAF7F6] px-5 py-4 rounded-2xl text-sm font-bold border border-transparent hover:border-rose-50 transition-all">
                {value || "Not provided"}
            </div>
        )}
    </div>
