...
const Header = () => {
  ...
  const [bakeries, setBakeries] = useState([]); // added bakeries
  ...
  // ✅ Fetch bakery categories (Pastries, Bread, Cookies)
  useEffect(() => {
                      ...
                      <div className="absolute top-full left-0 mt-1 bg-white border rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-50 min-w-[150px]">
                        {bakeries.length > 0 ? (
                          bakeries.map((b) => (
                            <Link
                              key={b._id}
                              to={`/bakeries/${b._id}`} // click will navigate and fetch
          ...
          {!isLoggedIn ? (
            <div className="flex items-center text-sm font-semibold gap-3">
              <Link
                ...
                style={{
                  color:
                    location.pathname === "/login" ? secondaryPink : "",
                }}
              >
                Login
              </Link>
              ...
              <Link
                ...
                style={{
                  color:
                    location.pathname === "/register" ? secondaryPink : "",
                }}
              >
                Register
              </Link>
